...
app.put('/api/usuarios/:id', (req, res) => {
    const { id } = req.params;
    const { nome, email, cpf, senha, ano } = req.body;

    db.query('UPDATE usuarios SET nome = ?, email = ?, cpf = ?, senha = ?, ano = ?, WHERE id = ?,', [nome, email, cpf, senha, id, ano], (err, results) => {
...
app.post('/api/cadastrarU', (req, res) => {
    ...
    db.query('INSERT INTO usuarios (nome, email, cpf, senha, ano) VALUES (?, ?, ?, ?, ?)', [nome, email, cpf, senha, ano], (err, results) => {
